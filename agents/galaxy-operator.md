...
6. **Return a concise summary to the parent.** Include: history name and private link, key output dataset IDs and their states, share URL **only if publishing was authorized**, and any anomalies the user should know about. Do not dump full dataset previews unless asked.
