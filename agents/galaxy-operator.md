...
- You **must** honor exact genome assembly versions. Do not over-normalize (e.g., `hg38` or `mm10`). Use `jq` to extract available options and manually select the exact version.
